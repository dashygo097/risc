...
object RV32IDecoderUtils extends RegisteredUtils[DecoderUtils] with RV32IUOp {
  ...
  override def utils: DecoderUtils = new DecoderUtils {
    ...
    override def default: List[BitPat] =
      List(N, N, IMM_X, X, X, N, X, X, X, X, UOP_X)
    ...
    override def table: Array[(BitPat, List[BitPat])] = Array(
      ...
      // I-Type: Jump
      enc("JALR") -> List(Y, Y, IMM_I, N, N, N, N, Y, N, N, UOP_JALR),

      // I-Type: CSR
      enc("CSRRW")  -> List(Y, Y, IMM_I, N, N, N, N, N, Y, N, UOP_CSRRW),
      enc("CSRRS")  -> List(Y, Y, IMM_I, N, N, N, N, N, Y, N, UOP_CSRRS),
      enc("CSRRC")  -> List(Y, Y, IMM_I, N, N, N, N, N, Y, N, UOP_CSRRC),
      enc("CSRRWI") -> List(Y, Y, IMM_I, N, N, N, N, N, Y, N, UOP_CSRRWI),
      enc("CSRRSI") -> List(Y, Y, IMM_I, N, N, N, N, N, Y, N, UOP_CSRRSI),
      enc("CSRRCI") -> List(Y, Y, IMM_I, N, N, N, N, N, Y, N, UOP_CSRRCI),

      // S-Type
      enc("SB") -> List(Y, N, IMM_S, N, N, N, Y, N, N, N, UOP_SB),
      enc("SH") -> List(Y, N, IMM_S, N, N, N, Y, N, N, N, UOP_SH),
      enc("SW") -> List(Y, N, IMM_S, N, N, N, Y, N, N, N, UOP_SW),

      // B-Type
      enc("BEQ")  -> List(Y, N, IMM_B, N, N, N, N, Y, N, N, UOP_BEQ),
      enc("BNE")  -> List(Y, N, IMM_B, N, N, N, N, Y, N, N, UOP_BNE),
      enc("BLT")  -> List(Y, N, IMM_B, N, N, N, N, Y, N, N, UOP_BLT),
      enc("BGE")  -> List(Y, N, IMM_B, N, N, N, N, Y, N, N, UOP_BGE),
      enc("BLTU") -> List(Y, N, IMM_B, N, N, N, N, Y, N, N, UOP_BLTU),
      enc("BGEU") -> List(Y, N, IMM_B, N, N, N, N, Y, N, N, UOP_BGEU),
      ...
      // J-Type
      enc("JAL") -> List(Y, Y, IMM_J, N, N, N, N, Y, N, N, UOP_JAL),
