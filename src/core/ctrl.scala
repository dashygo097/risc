...
class RV32GloblCtrlUnit extends Module {
  ...
  alu_ctrl := MuxLookup(opcode, "b0000".U)(Seq(
    "b0110011".U -> MuxLookup(Cat(funct7, funct3), "b0000".U)(Seq( // R-type
    ...
    "b0010011".U -> MuxLookup(funct3, "b0000".U)(Seq( // I-type
      "b000".U -> ALUOp.ADD,
      "b100".U -> ALUOp.XOR,
      "b110".U -> ALUOp.OR,
      "b111".U -> ALUOp.AND,
  ...
  mem_ctrl := MuxLookup(opcode, "b000".U)(Seq(
    "b0000011".U -> MuxLookup(funct3, "b000".U)(Seq( // Load, I-Type
      "b000".U -> MemOp.LB,
      "b001".U -> MemOp.LH,
      "b010".U -> MemOp.LW,
      "b100".U -> MemOp.LBU,
    ...
    "b0100011".U -> MuxLookup(funct3, "b000".U)(Seq( // Store, S-Type
      "b000".U -> MemOp.SB,
      "b001".U -> MemOp.SH,
      "b010".U -> MemOp.SW
    ))
